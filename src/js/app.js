...
function startApp() {
    ...
    idCliente();
    nombreCliente(); // Añade nombre del cliente al objeto de cita
...
async function reservarCita() {
    ...
    //console.log([...datos]);  Toma una copia de formdata y lo va a formatear so puedes inspeccionar que estás colocando en el formdata antes de enviarlo
